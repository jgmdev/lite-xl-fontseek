...
---@class FontInfo : core.object
---@field private reader FontReader
---@field public path string @Path of the font file
---@field public data FontInfo.data[] @Holds the metadata for each of the embedded fonts
